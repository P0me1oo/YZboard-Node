...
func (p *PanelControlPlane) Report(payload ReportPayload) error {
	return p.client.Report(payload.ReportID, payload.Traffic, payload.RelayTraffic, payload.Alive, payload.Online, payload.CPU, payload.Mem, payload.Swap, payload.Disk, payload.Metrics)
}
